...
export default function PricingPage() {
  return <div className="stack">
    ...
    <section className="pricing-grid">
      ...
      <article className="price-card panel pop-shadow"><p className="eyebrow">PREMIUM</p><h2>プレミアム</h2><p className="price">¥500<span>（税込）/月</span></p><ul><li>単語帳・カードを無制限に作成</li><li>学習統計と高度な復習設定を順次追加予定</li><li>7日間の無料トライアル</li></ul><Link className="button" href="/settings">7日間無料で試す</Link></article>
    </section>
