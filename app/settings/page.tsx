...
export default function SettingsPage() {
  ...
  return <section className="panel stack"><h1>設定・プラン</h1><p>有料プランでは無料利用枠を超えて単語帳を作成できます。</p>{message && <p className="error">{message}</p>}<button className="button" onClick={checkout}>有料プランを開始</button></section>;
}
